...
<div class="max-w-sm w-full">
  ...
  <script>
    let votingId = <?php echo json_encode($votingId, 15, 512) ?>;
    let series = <?php echo json_encode($series, 15, 512) ?>;
    let candidate = <?php echo json_encode($candidate, 15, 512) ?>;
    let chart = "";
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\revan\OneDrive\Documents\voter\voter\resources\views/result.blade.php ENDPATH**/ ?>