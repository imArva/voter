                    ...
                    <div class="md:w-2/3">
                        <div class="item px-6 py-6" x-data="{ isOpen: false }">
                            ...
                            <div x-show="isOpen" @click.away="isOpen = false" class="mt-3"
                                ...
                                <p>Voter adalah platform website yang digunakan untuk pemungutan suara dalam pemilihan umum
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="item px-6 py-6" x-data="{ isOpen: false }">
                            ...
                            <div x-show="isOpen" @click.away="isOpen = false" class="mt-3"
                                ...
                                <p>Untuk menggunakan Voter, Anda perlu mengunjungi situs web dan mengikuti petunjuk yang
                                    diberikan. Biasanya, Anda akan diminta untuk membuat akun atau login, memilih pilihan
                        ...
                        <div class="item px-6 py-6" x-data="{ isOpen: false }">
                            ...
                            <div x-show="isOpen" @click.away="isOpen = false" class="mt-3"
                                ...
                                <p>Untuk mendapatkan akun di website kami, silakan mengikuti prosedur berikut: Karena
                                    ...
                                    manual. Anda dapat menghubungi kami melalui [kontak/email/layanan pesan] kami untuk
                                    meminta akun.</p>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ACHMAD SURYA SAPUTRA\Website Achmad Surya\voter\resources\views/faq.blade.php ENDPATH**/ ?>