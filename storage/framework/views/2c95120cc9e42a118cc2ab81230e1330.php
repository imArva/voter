            ...
            <div class="flex md:order-2">
              <?php if(auth()->guard()->check()): ?>
                <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                    ...
                    type="button"><p class="pr-2">SETTING</p><i class="fa fa-chevron-down"></i>
                </button>
                <div id="dropdown"
                    ...
                    <ul class="py-2 text-sm" aria-labelledby="dropdownDefaultButton">
                        ...
                        <li>
                            <?php if(auth()->user()): ?>
                                <a href="/logout"
                                    class="block px-4 py-2 text-secondary hover:underline font-medium text-sm text-center mr-3 md:mr-0">Logout</a>
                            <?php endif; ?>
                        </li>
                    </ul>
                </div>
                <?php else: ?>
                    <a href="/login"
                        class="text-secondary bg-tertiary hover:text-primary font-medium rounded-full text-sm px-4 py-2 text-center mr-3 md:mr-0">Login
                        Now</a>
                <?php endif; ?>
                <button data-collapse-toggle="navbar-sticky" type="button"
                    ...
                    <svg class="w-5 h-5 text-tertiary hover:bg-primary rounded-l-full"
    ...
    <footer class="bg-primary text-tertiary">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul class="font-medium">
                            <li>
                                <a href="https://instagram.com/ananditanyl" class="hover:underline"
                                    target="_blank">Anandita Nayla</a>
                            </li>
                            <li>
                                <a href="https://instagram.com/ach13_" class="hover:underline" target="_blank">Achmad
                                    Surya</a>
                            </li>
                            <li>
                                <a href="https://instagram.com/revanzasono" class="hover:underline"
                                    target="_blank">Arva Revanza</a>
                            </li>
                            <li>
                                <a href="https://instagram.com/hfrzyy_" class="hover:underline" target="_blank">Helmi
                                    Fawwaz</a>
                            </li>
                            <li>
                                <a href="https://instagram.com/hi_qiloo" class="hover:underline"
                                    target="_blank">Aqiilah Irsalina</a>
                            </li>
                            <li>
                                <a href="https://discord.gg/4eeurUVvTy" class="hover:underline"
                                    target="_blank">Muhammad Zufar</a>
                            </li>
                            <li>
                                <a href="https://discord.gg/4eeurUVvTy" class="hover:underline"
                                    target="_blank">Rahmadini</a>
                            </li>
                            <li>
                                <a href="https://discord.gg/4eeurUVvTy" class="hover:underline"
                                    target="_blank">Kartika</a>
                            </li>
                            <li>
                                <a href="https://discord.gg/4eeurUVvTy" class="hover:underline"
                                    target="_blank">Bintang Aira</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm sm:text-center">© 2023 <a href="/" class="hover:underline">Voter</a>.
                    All Rights Reserved.
                </span>
...
<?php /**PATH D:\ACHMAD SURYA SAPUTRA\Website Achmad Surya\voter\voter\resources\views/layouts/user.blade.php ENDPATH**/ ?>