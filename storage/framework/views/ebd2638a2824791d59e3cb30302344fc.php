        ...
        <div
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 text-center text-white">
                ...
                <div class="Url py-5">
                    ...
                    <hr  class="py-4">
                    <a href="/voting/<?php echo e($voting->slug); ?>" class="text-blue-500 underline">www.voter.com/voting/<?php echo e($voting->slug); ?></a>
                </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ACHMAD SURYA SAPUTRA\Website Achmad Surya\voter\resources\views/listvote.blade.php ENDPATH**/ ?>