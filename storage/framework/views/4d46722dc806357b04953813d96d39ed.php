...
<body class="antialiased overflow-x-hidden">
    ...
    <nav class="fixed top-0 z-50 w-full bg-secondary text-white border-b border-tertiary">
    ...
    <aside id="logo-sidebar"
        class="bg-secondary fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full border-t border-tertiary sm:translate-x-0"
        aria-label="Sidebar">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-secondary text-white">
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="/dashboard"
                        class="flex items-center p-2 rounded-lg hover:text-[#23252A] group hover:bg-white transition-all">
                        <svg class="w-5 h-5 transition duration-75 dark:text-gray-400 group-hover: dark:group-hover:text-white"
                ...
                <li>
                    <a href="/mylinks"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Your vote links</span>
                    </a>
                </li>
            </ul>
        </div>
...
</html><?php /**PATH D:\ACHMAD SURYA SAPUTRA\Website Achmad Surya\voter\voter\resources\views/layouts/admin.blade.php ENDPATH**/ ?>